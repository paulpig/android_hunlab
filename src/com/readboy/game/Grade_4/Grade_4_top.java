...
public class Grade_4_top extends GameActivity implements Watcher{

	//protected Object Alock;
	
	Supply_Grade_4_top supply_project_thread;
	...
	protected void GetProAndAns(int type){
		...
		supply_project_thread=new Supply_Grade_4_top(problem_hander,Alock,type);
	...
	protected void rankingListen(){
		 ranking.setOnClickListener(new OnClickListener() {
				public void onClick(View arg0) {
		             ...
		             intent.setClass(Grade_4_top.this, rankingList.class);
